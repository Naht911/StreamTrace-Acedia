          ...
          <li class="toggleBtn">
               @if (Auth::check())
                    @php
                         ...
                         $count = 0;
                         $noti = \App\Models\Notification::where('user_id', Auth::user()->id)->get();
               ...
               @if (Auth::check() && (isset($count) && $count > 0))
                    <span class="fa-solid fa-bell fa-shake">
                    </span>
               @else
               ...
               <div class="detail">
                    @if (Auth::check())
                         ...
                         <div class="row text-white">
                              <a href="{{ route('profile.notification') }}"> Notification </a>
                         </div>
                         <div class="row text-white">
