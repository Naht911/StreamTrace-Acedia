...
<div class="titles">
    <div class="container">
         <div class="title">Newest on Prime Video</div>
         <div class="card-sliders card-sliders-1">
              <div class="card-slider swiper-wrapper">

                   @foreach ($newest_primeVideo as $item)
...
<div class="titles">
    <div class="container">
         <div class="title">Newest on Netflix</div>
         <div class="card-sliders card-sliders-1">
              <div class="card-slider swiper-wrapper">

                   @foreach ($newest_netflix as $item)
                        <div class="card swiper-slide">
                          <div class="image">
                              <a href="{{ route('home.movie.movie_detail', $item->id) }}">
                               <img src="{{ asset($item->poster_url) }}" alt="" height="240" width="165"  />
...
<div class="titles">
    <div class="container">
         <div class="title">Newest on Apple TV</div>
         <div class="card-sliders card-sliders-1">
              <div class="card-slider swiper-wrapper">

                   @foreach ($newest_appleTV as $item)
                        <div class="card swiper-slide">
                          <div class="image">
                              <a href="{{ route('home.movie.movie_detail', $item->id) }}">
                               <img src="{{ asset($item->poster_url) }}" alt="" height="240" width="165"  />
