               ...
               <div class="row">
                    <div class="col-xl-12 p-0">
                         <div class="login-card">
                              <form id="Login" class="theme-form login-form" action="{{ route('login.process') }}" method="POST">
                                   @csrf
                                   <h4>Login</h4>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                                             <input class="form-control" type="email" name="email" id="email" required="" placeholder="your Email">
                                        </div>
               ...
               $("#Login").ajaxForm({
                    ...
                    success: function(data) {
                         if (data.status == 0) {
                              ...
                              //nếu status trả về 419 > tải lại trang
                              if (data.status == 419) {
                                   Swal.fire({
                                             title: "Finished!",
                                             text: 'Page expired. Please refresh this page.',
                                             type: "warning",
                                             confirmButtonClass: 'btn-success',
                                             confirmButtonText: 'OK'
                                        })
