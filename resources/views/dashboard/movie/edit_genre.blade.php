                         ...
                         <form id="create_pin">
                              <div class="row g-3">
                                   <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="name" name="name" type="text" placeholder="Genre name" required onkeyup="gen_slug(this)" value="{{ $genre->name }}">
                                   </div>
                                   ...
                                   <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                             ...
                                             <input class="form-control" id="slug" name="slug" type="text" placeholder="Genre slug" aria-describedby="inputGroupPrepend2" required value="{{ $genre->slug }}">
                                        </div>
                                   </div>
                              </div>
          ...
          $(document).ready(function() {
               ...
               $('#create_pin').on('submit', function(e) {
                    ...
                    $.ajax({
                         ...
                         url: "{{ route('dashboard.movie.update_genre', $genre->id) }}",
                         method: "POST",
                         processData: false,
                         contentType: false,
                         dataType: 'json',
