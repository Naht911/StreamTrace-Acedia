                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="slug" name="slug"
                                            type="text" placeholder="Slug" value="{{ $movie->slug }}">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-lg list-category" multiple="multiple"
                                            ...
                                            @foreach ($genres as $genre)
                                                <option value="{{ $genre->id }}"
                                                    @foreach ($movie->genres as $movie_genre) @if ($movie_genre->id == $genre->id) selected @endif @endforeach>
                                                    {{ $genre->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="duration" name="duration"
                                            type="text" placeholder="Duration" value="{{ $movie->duration }}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-lg" id="release_year" name="release_year">
                                            @for ($i = 2024; $i >= 1900; $i--)
                                                <option value="{{ $i }}"
                                                    @if ($movie->release_year == $i) selected @endif>{{ $i }}
                                                </option>
                                            @endfor
                                ...
                                <div class="col-md-8 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" type="file" id="file-input"
                                            name="poster">
                                        <div class="alert alert-success" id="thumb-new"><small><i>No poster have been
                                                    selected yet</i></small></div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <label for="">Current Poster</label>
                                    <div class="mb-3">
                                        <img src="{{ asset($movie->poster_url) }}" alt="" class="thumb"
                                            id="thumb-old" onclick="zoom('{{ asset($movie->poster_url) }}')">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" type="text" id="trailer_url"
                                            name="trailer_url" value="{{ $movie->trailer_url }}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="mb-3">
